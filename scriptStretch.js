$(document).ready(function(){
  ...
  function playlistInfo() {
    // FIXME: index.html cannot open the fson file from firebase because it doesnt have permission
    $.get(('https://firebasestorage.googleapis.com/v0/b/playlist-71108.appspot.com/o/favAlbums.json?alt=media&token=60eafc58-a67c-4f13-99e5-03421df5e662'), function(data){
  ...
  function playlistInfoPage2() {
    $.get(('https://firebasestorage.googleapis.com/v0/b/playlist-71108.appspot.com/o/favAlbums.json?alt=media&token=60eafc58-a67c-4f13-99e5-03421df5e662'), function(dataPage2){
